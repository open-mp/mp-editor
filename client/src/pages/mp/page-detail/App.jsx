    ...
    render() {
        ...
        return (<div className="mp-papge-detail">
            ...
            <Row>
                ...
                <Col span={8}><ColorPicker color={page.config.navigationBarBackgroundColor} onChange={this.colorChange('config.navigationBarBackgroundColor')} /></Col>
            </Row>
            <Row>
            ...
            <Row>
                ...
                <Col span={8}><ColorPicker color={page.config.backgroundColor}  onChange={this.colorChange('config.backgroundColor')}  /></Col>
            </Row>
            <Row>
                <Col span={4}>下拉文字颜色</Col>
                <Col span={8}>
                    <Select value={page.config.backgroundTextStyle} onChange={this.handleChange}  name="config.backgroundTextStyle">
