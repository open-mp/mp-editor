...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/pages/mp/page-list/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/pages/mp/page-list/App.jsx":
/*!****************************************!*\
  !*** ./src/pages/mp/page-list/App.jsx ***!
  \****************************************/
/*! no static exports found */
...
var columns = [{
    ...
    bodyRender: function bodyRender(data) {
        return _react2.default.createElement(
            'span',
            null,
            data.structure == 'static' ? '静态结构页' : '动态结构'
        );
    }
}, {
    title: '描述',
    ...
    title: '操作',
    width: '200px',
    bodyRender: function bodyRender(page) {
        // 动态结构页
        // 静态结构页
        if (page.structure == 'static') {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { href: '/mp/page-detail?pageId=' + page.id },
                    _react2.default.createElement(
                        _zent.Button,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { href: '/mp/content-list?pageId=' + page.id },
                    _react2.default.createElement(
                        _zent.Button,
                        { type: 'primary', outline: true },
                        '\u5185\u5BB9\u5217\u8868'
...
/***/ "./src/pages/mp/page-list/main.js":
/*!****************************************!*\
  !*** ./src/pages/mp/page-list/main.js ***!
  \****************************************/
/*! no static exports found */
...
var _App = __webpack_require__(/*! ./App.jsx */ "./src/pages/mp/page-list/App.jsx");

var _App2 = _interopRequireDefault(_App);

__webpack_require__(/*! ./main.pcss */ "./src/pages/mp/page-list/main.pcss");
...
/***/ "./src/pages/mp/page-list/main.pcss":
/*!******************************************!*\
  !*** ./src/pages/mp/page-list/main.pcss ***!
  \******************************************/
/*! no static exports found */
