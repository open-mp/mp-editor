...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/pages/mp/dynamic-setting/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/pages/mp/dynamic-setting/App.jsx":
/*!**********************************************!*\
  !*** ./src/pages/mp/dynamic-setting/App.jsx ***!
  \**********************************************/
/*! no static exports found */
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.selectBundle = function (evt) {
            var target = evt.target;
            var page = _this.state.page;
            var name = target.name,
                type = target.type,
        ...
        _this.deleteBundle = function (evt) {
            var page = _this.state.page;
            var name = evt.name,
                type = evt.type,
                value = evt.value;
            ...
            page.bundleList = page.bundleList.filter(function (v) {
                return v != value;
            });
            _this.setState({
                page: page
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            _context.next = 4;
                            return mpApi.saveMpDynamicSetting(mpId, page);
    ...
    _createClass(App, [{
        ...
        value: function () {
            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                var _getQuery2, mpId, page;

                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _getQuery2 = (0, _url.getQuery)(), mpId = _getQuery2.mpId;
                                _context2.next = 3;
                                return mpApi.getMpDynamicSetting(mpId);
...
/***/ "./src/pages/mp/dynamic-setting/main.js":
/*!**********************************************!*\
  !*** ./src/pages/mp/dynamic-setting/main.js ***!
  \**********************************************/
/*! no static exports found */
...
var _App = __webpack_require__(/*! ./App.jsx */ "./src/pages/mp/dynamic-setting/App.jsx");

var _App2 = _interopRequireDefault(_App);

__webpack_require__(/*! ./main.pcss */ "./src/pages/mp/dynamic-setting/main.pcss");
...
/***/ "./src/pages/mp/dynamic-setting/main.pcss":
/*!************************************************!*\
  !*** ./src/pages/mp/dynamic-setting/main.pcss ***!
  \************************************************/
/*! no static exports found */
